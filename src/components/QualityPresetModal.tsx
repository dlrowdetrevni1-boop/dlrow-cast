...
export const QualityPresetModal: React.FC<QualityPresetModalProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-xl bg-zinc-950 rounded-2xl shadow-2xl shadow-black/90 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="p-4 sm:p-5 shadow-md shadow-black/30 flex items-center justify-between bg-zinc-900/90">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-zinc-800 shadow-md shadow-black/40 flex items-center justify-center text-zinc-200">
                ...
                return (
                  <button
                    ...
                    className={`p-3.5 rounded-xl text-left transition-all relative ${
                      isSelected
                        ? "bg-zinc-800 text-white font-medium shadow-md shadow-black/40"
                        : "bg-zinc-900/60 hover:bg-zinc-900 text-zinc-300 shadow-sm shadow-black/20"
                    }`}
                  >
                  ...
                  >
                    <div
                      className={`p-2 rounded-lg shrink-0 ${
                        isSelected ? "bg-zinc-700 text-white shadow-sm" : "bg-zinc-800 text-zinc-400 shadow-sm"
                      }`}
                    >
        ...
        {/* Footer */}
        <div className="p-4 shadow-lg shadow-black/40 bg-zinc-900/60 flex items-center justify-between">
